...
//设置机器人状态
 ...
 private:
  ...
  //着色器程序的属性 
  GLuint _posAttrColorArray;        //顶点位置
  GLuint _colAttrColorArray;        // 顶点颜色
  GLuint _matrixUniformColorArray;  // 变换矩阵
  GLuint _normAttrColorArray;       // 顶点法线

  GLuint _posAttrSolidColor;     // 顶点位置
  GLuint _colUniformSolidColor;  //顶点颜色
  GLuint _colAttrSolidColor;
  GLuint _matrixUniformSolidColor;  // 变换矩阵
  GLuint _normAttrSolidColor;       // 顶点法线
