/*! @file MiniCheetah.h
 *  @brief 构建小型猎豹四足动物对象的实用函数
 *此文件基于minichetahullrotormodel_mex.m并构建一个模型
 *小型猎豹机器人的。所有物体的惯性参数是
 *由CAD确定。
 *
 */
...
Quadruped<T> buildMiniCheetah() {
  ...
  cheetah._abadLinkLength = 0.062; //0.062  实际0.085
  cheetah._hipLinkLength = 0.211; //0.209
  cheetah._kneeLinkLength = 0.20;//0.175
